...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(
        pipeline_func=supermarket_intelligence_pipeline, package_path=output_filename
    )
    print(
        "🏁 Success! Upload this file to your Kubeflow Pipelines UI to trigger the execution matrix."
    )
