...
class RecommendationRequest(BaseModel):
    ...
    transaction_data: Dict[str, Any] = Field(..., description="Dictionary mapping exactly to your engineering.supermarket table columns")
...
async def generate_offer(payload: RecommendationRequest):
    ...
    try:
        ...
        report = behavior_analyst.generate_personalized_offers(
            ...
            last_transaction_df=df_features
        )
