...
class SecurityAgentEngine:
    ...
    async def chat_investigate(self, session_id: str, user_query: str, velocity_context: str) -> str:
        ...
        await redis_cache.client.setex(memory_key, 43200, updated_history)  # 12 hours in seconds
