...
class VectorStoreClient:
    ...
    def _ensure_collection_state(self):
        ...
        try:
            ...
            if not self.client.collection_exists(collection_name=self.collection_name):
                ...
                logger.info(
                    f"🚀 Successfully provisioned remote collection '{self.collection_name}' on Qdrant Cloud."
                )
    ...
    def get_embedding(self, text: str) -> list:
        ...
        try:
            ...
            logger.error(
                f"❌ Hugging Face embedding extraction error: {response.status_code} - {response.text}"
            )
