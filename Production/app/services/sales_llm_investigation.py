...
class SalesInvestigationRequest(BaseModel):
    ...
    investigation_date: str = Field("2012-12-10", example="2026-07-25", description="Date of sales audit.")
    ...
    sales_trend: str = Field("Decreasing", example="Decreasing", description="Sales trajectory: Increasing, Decreasing, Stable.")
    custom_context: Optional[str] = Field(None, example="Discount increased during Q2 promo campaign.")
